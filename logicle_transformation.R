...
transform_path <- "/storage/pavinap.priyaa/Mphasis/dataset/"
cleaned_path   <- "/storage/pavinap.priyaa/Mphasis/dataset/final_cleaned/"
output_path    <- "/storage/pavinap.priyaa/Mphasis/dataset/final_transformed"
...
get_tube <- function(name) {
  matches <- regmatches(name, regexec("BLAST110_\\d+_(P\\d)", name))
  matches[[1]][2]
}
...
pdf("transformation_contours.pdf", width = 12, height = 6)
pdf_hist <- "transformation_histograms.pdf"
