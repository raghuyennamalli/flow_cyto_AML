...
# Input files
# ==============================
raw_file <- "/storage/mezya.sezen/mphasis/dataset/after_doublet_removal/BLAST110_15_P1_cleaned_doubletRemoval.fcs"                     # before preprocessing
cleaned_file <- "/storage/mezya.sezen/mphasis/dataset/transformed/BLAST110_15_P1_cleaned_doubletRemoval_transformed.fcs"         # after preprocessing
output_pdf <- "/storage/mezya.sezen/mphasis/Contour_Transformation.pdf"
