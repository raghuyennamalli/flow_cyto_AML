...
# Parameters
# -------------------------------
fcs_folder = "/storage/pavinap.priyaa/Mphasis/dataset/after_scaling/"   # where your .fcs files live
labels_folder = "/storage/pavinap.priyaa/Mphasis/dataset/Labels"              # folder with label csvs
...
print(f"\n[DEBUG] Script ended at: {time.ctime(end_time)}")
print(f"[DEBUG] Total elapsed time: {int(hours)}h {int(minutes)}m {int(seconds)}s")
